...
export function QueueDisplay() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed top-0 right-0 h-full w-full max-w-sm bg-background border-l border-zinc-400 z-50 transform transition-transform duration-300 ease-in-out ${
